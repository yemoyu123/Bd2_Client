...
<div align="center">
  ...
  <h3>
    我是最近才看issue的，发现居然有这么多申请白名单的（已处理完成）<br>
    为提高效率，<b>群里现已内置机器人辅助过白 🤖</b><br>
    <br>
  ...
  <h2>频道：https://discord.gg/fTJsUZK3JE</h2>
</div>
...
2.  **悬浮窗登录**：进入游戏后，点击屏幕上的**悬浮窗**进行登录。
    ...
    * **新朋友请注意**：如果您是新注册账号，会提示“您所在的地区无法提供服务”。**请加群按照上方流程（查账号 -> @我）申请白名单**，为您加入白名单后即可正常注册登录。
...
3.  **注册登录**：启动游戏后即可进行注册和登录。
    * **新朋友请注意**：和手机端一样，新注册账号**请加群按照上方流程（查账号 -> @我）申请白名单**，否则会显示地区不可用。
